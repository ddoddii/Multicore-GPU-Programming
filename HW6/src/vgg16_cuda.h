...
private:
    ...
    /// im2col
    float* d_input_padded_im2col;
    float* d_C1_1_feature_map_padded_im2col;
    float* d_S1_feature_map_padded_im2col;
    float* d_C2_1_feature_map_padded_im2col;
    float* d_S2_feature_map_padded_im2col;
    float* d_C3_1_feature_map_padded_im2col;
    float* d_C3_2_feature_map_padded_im2col;
    float* d_S3_feature_map_padded_im2col;
    float* d_C4_1_feature_map_padded_im2col;
    float* d_C4_2_feature_map_padded_im2col;
    float* d_S4_feature_map_padded_im2col;
    float* d_C5_1_feature_map_padded_im2col;
    float* d_C5_2_feature_map_padded_im2col;
