...
void vgg16_cpu::predict(const uint8_t* const image, int batch) {
    ...
    // // for (int i = 0; i < batch; i++) {
    // for (int j = 60; j < 80; j++) {
    //     std::cout << j << " " << C1_1_feature_map_padded[j] << "\n";
    // }
    // std::cout << std::endl;
    // // }
    // std::cout << std::endl;
...
void vgg16_cpu::pool(float* input, float* output,
                     int B, int C,
                     int H, int W) {
    // Initilaize variable
    int scale = 2;
