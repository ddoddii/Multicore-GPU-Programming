...
@.str.2 = private unnamed_addr constant [28 x i8] c"...(%d MUL %d) SUB %d = %d\0A\00", align 1
...
define i32 @Add(i32*, i32*, i32*, i64) #0 {
  ...
  ; %17 = sub i64 %sextmp, %10
  ;%17 = sext i64 %subtmp to i64
  %18 = load i64, i64* %8, align 8
  %subtmp2 = sub i64 %17, %18
  ;%subtmp2 = sub i64 %multmp1, %10
  %19 = trunc i64 %subtmp2 to i32
...
define i32 @main() #0 {
  ...
  %27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.2, i32 0, i32 0), i32 %20, i32 %24, i32 %25, i32 %26)
  ret i32 0
}
